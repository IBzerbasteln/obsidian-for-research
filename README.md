...
2. **Clone the Vault:** Download or clone this vault to your local machine.
	...
	2. Open the `.zip` file.
	3. On Windows: Click `Extract all`, and unzip the files to a directory of your choice on your computer.[^1]
	4. On Mac: Copy the contents to a directory of your choice on your computer.[^2]
...
## Changelog
- **v.0.3.2 (2025-11-11)**: Added applications for LLMs and background on Markdown format
- **v.0.3.1 (2025-11-11)**: Added shortcuts for Mac.
